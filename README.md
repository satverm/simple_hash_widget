...
## Updates:
    - tk_hash_pers_widget.py is a version where you can add your own sequence in the code itself and have a unique file to generate a unique hash. 
    ...
    - Though comments have been added to create your own coded sequence, some working knowledge of python will be useful. 
...
Then you can store or write the first few digits and use this program to test the input and the hash digits.
...
## How to get the python file from github:
 ...
 - You can fork the repository if you have a github account  and play withe program  and contribute to improve the program.
 ...
 - You are free to modify the program and play around with it. For example, if you remove the "show='\*'" from the input entry widgets then the inputs will be visible to you in place of ***... when you enter any input data.

## Using the python file:
On running the python file a window will popup with the entry boxes and text labels.
...
Please note there is a hash of blank entry box also, so you can generate hashes even without any input.The code can be modified to warn if the hash is being genertated without any input in the entry boxes. 
...
You can store or write the first four to five hex digits in a secure place to test your input or password with the same passphrase to  test if it is correct or not. 
...
## TODO:
- Add the option to store and retrieve passwords : ## under progress

...
def get_hash_input():
	...
	if hsh_input == hsh_confirm:
		...
		label_ip_hash.configure(text='Enter input again', fg= 'red')
...
label1 = tk.Label(frm1, text="Lets have fun with hashing".upper(), padx=20, pady=40, fg='purple')
label1.pack()
...
btn_input_hsh= tk.Button(frm1, text="Click to get  hash of input ", padx=10, pady=20,command= get_hash_input, relief= "raised", bg= 'grey', fg= 'white', border=10, width=30)
